...
%% -----------------------------
\usepackage{hyperref}
\hypersetup{colorlinks = true, urlcolor = gray!70!white, linkcolor = .}
...
\newcommand{\probb}[1]{\Pr \left[ #1 \right]}
\newcommand{\esp}[1]{\mathrm{E} {\left[ #1 \right]}} % espérance
\newcommand{\var}[1]{\mathrm{Var} {\left( #1   \right)}}
\newcommand{\covar}[1]{\mathrm{Cov} {\left( #1   \right)}}
\newcommand{\laplace}{\mathcal{L}}
\newcommand*\diff{\mathop{}\!\mathrm{d}}
\newcommand{\indic}[1]{\mathds{1}_{ {\left\{ #1 \right\}}   }}
...
\definecolor{AppendixColor}{HTML}{ff0000}
...
% Header
\fancyhead{} 	% Reset
\fancyhead[L]{Cheatsheet for~\cours~(\textbf{\sigle})}
\fancyhead[R]{\auteur}
