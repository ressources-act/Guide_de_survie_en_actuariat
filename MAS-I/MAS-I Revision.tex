...
\begin{itemize}[align=left,leftmargin=*]
  ...
  Note that as $n\to\infty$, $T\to N(0,1)$
  ...
  \begin{itemize}
    \item Two independent normal distributions:
    \begin{align*}
    ...
    \item Two dependent distributions:
    \begin{align*}
      (x_1,y_1),...,(x_n,y_n)\sim \mathrm{bivariate\:Normal\:distribution} 
    \end{align*}
  \end{itemize}
\end{itemize}
