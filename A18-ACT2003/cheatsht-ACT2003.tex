...
\begin{align*}
\esp{Y | x_o } &\in \Bigg[ \widehat{Y}_0 \pm t_{(n - 2), \frac{k}{2}} \sqrt{s^2 \bigg( \frac{1}{n} + \frac{(x_0 - \bar{x})^2}{S_{XX}} \bigg)} \Bigg] \\
Y_0 &\in \Bigg[ \widehat{Y}_0 \pm t_{(n - 2), \frac{k}{2}} \sqrt{s^2 \bigg( 1 + \frac{1}{n} + \frac{(x_0 - \bar{x})^2}{S_{XX}} \bigg)}\Bigg]
\end{align*}
