...
\begin{itemize}
	...
	Pour en avoir un centré autour de la prévision, il faut faut définir le pivot approximatif avec la méthode Delta.
...
Selon le \textbf{TRV}, $2 \big(\ell(\tilde{\theta}) - \ell(\hat{\theta})\big) \sim\chi^{2}_{n - p'}$ si le modèle de $\hat{\theta}$ est adéquat
