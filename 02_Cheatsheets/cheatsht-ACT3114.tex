...
\begin{definitionNOHFILL}[\textbf{Adaptive Boosting} (Adaboost)]
...
%	supppose étiquettes des classes -1 et +1
\end{definitionNOHFILL}
...
\begin{definitionNOHFILL}[Gradient Boosting]
...
\begin{definitionNOHFILL}[Stochastic Gradient Boosting]
