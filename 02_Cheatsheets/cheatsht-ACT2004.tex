...
%Shape: Rectangle [id:dp8495101049962321] 1st orange x + 1 block
\draw  [draw opacity=0][fill={rgb, 255:red, 245; green, 166; blue, 35 }  ,fill opacity=0.62 ] (165.5,49.67) -- (185.5,49.67) -- (185.5,60.67) -- (165.5,60.67) -- cycle ;
%Shape: Rectangle [id:dp36994320892995547] 1st  green n - 1 block
\draw  [draw opacity=0][fill={rgb, 255:red, 126; green, 211; blue, 33 }  ,fill opacity=0.47 ] (186,49.67) -- (200,49.67) -- (200,60.67) -- (186,60.67) -- cycle ;
%Shape: Rectangle [id:dp1898439661348572]  2nd orange x + 1 block
\draw  [draw opacity=0][fill={rgb, 255:red, 245; green, 166; blue, 35 }  ,fill opacity=0.62 ] (220.5,49.67) -- (238.5,49.67) -- (238.5,60.67) -- (220.5,60.67) -- cycle ;
%Shape: Rectangle [id:dp03149696608438113] 2nd  green n - 1 block
\draw  [draw opacity=0][fill={rgb, 255:red, 126; green, 211; blue, 33 }  ,fill opacity=0.47 ] (240.5,49.67) -- (255.5,49.67) -- (255.5,61.67) -- (240.5,61.67) -- cycle ;
...
%Shape: Rectangle [id:dp8016901331617778] orange x + 1
\draw  [draw opacity=0][fill={rgb, 255:red, 245; green, 166; blue, 35 }  ,fill opacity=0.36 ] (154.5,105.67) -- (140.5,105.67) -- (140.5,96.67) -- (154.5,96.67) -- cycle ;
%Shape: Rectangle [id:dp21968758506467512] green n - 1
\draw  [draw opacity=0][fill={rgb, 255:red, 126; green, 211; blue, 33 }  ,fill opacity=0.47 ] (157.5,96.67) -- (171.5,96.67) -- (171.5,105.67) -- (157.5,105.67) -- cycle ;
