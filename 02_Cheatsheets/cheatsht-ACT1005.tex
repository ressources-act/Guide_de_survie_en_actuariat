...
Surtout des employés gouvernementaux et de grandes compagnies privées; les RCR sont rares pour les employés de petites entreprises.
\end{definitionNOHFILL}
...
\begin{itemize}
	\item	Les régimes peuvent être contributifs (cotisations d'employeurs et d'employés) ou non-contributif (cotisations seulement des employés).
\end{itemize}
