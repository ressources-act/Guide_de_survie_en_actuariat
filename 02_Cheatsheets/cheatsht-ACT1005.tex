...
%%% + En fait, je me questionne à savoir si c'est important de le dire, je crois que on devrait focus à trouver une manière simple de dire que c'est un organisme très important.
%%%	--------------
		\end{itemize}
...
\addcontentsline{toc}{subsection}{Régimes à prestations déterminées (PD)}
...
\addcontentsline{toc}{subsection}{Régimes à cotisations déterminées (CD)}
...
\addcontentsline{toc}{subsection}{Résumé des différents RCR}
...
%%%	+	Ça veut dire que l'employeur pourrait encourager les employés à partir plus tôt en bonifiant le régime si jamais il avait trop de main d'oeuvre. De la même manière, il pourrait pénaliser les retraite anticipée et donner des bonifications importantes à ceux qui partent plus tard si la main d'oeuvre est plus rare (garder les gens en emploi avec des "cadeau").
%%%	---------------------
...
%%% + 	Je suis d'accord avec toi ! C'est un avantage dans la mesure ou l'employé ne pourra pas aller au casino avec l'argent que l'employeur souhaite lui donner pour la retraite.
%%%	--------------------
...
%%%	+	J'ai l'impression que c'est parce que on peut pas nécéssairement Dire aux employés qu'on va leur donner un meilleur revenu... on peut juste cotiser plus. Ça parle moins directement aux employés. 
%%%	--------------------
...
\subsection*{Hybrides}
\addcontentsline{toc}{subsection}{Hybrides}
...
\addcontentsline{toc}{subsection}{Autres caractéristiques}
...
%%%	NOTES
%%%	+	Quoi? (AJVR)
%%% +	Hypothèse : Pour que ce conjoint puisse utiliser ces fonds pour sa retraite à lui. Ça pourrait être à poser sur le forum.
%%%	------------------------
...
\begin{itemize}[leftmargin = *]
\item	On était pas rendu à régler la problèmatique des accidents de travail, mais plutôt de l'exploitation.
\end{itemize}
\end{rappel_enhanced}
