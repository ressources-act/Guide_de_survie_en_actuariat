...
\begin{description}
	\item[2011]	
		...
		\end{itemize}
	\item[2019]	Mise en place d'un régime supplémentaire permettant de:
		\begin{enumerate}[leftmargin = *]
...
\begin{conceptgen}{Quelques chiffres}
\begin{itemize}[leftmargin = *]
	\item	4M cotisants;
...
%\textbf{Financement}
%\begin{description}
%	\item[Cotisation]	des travailleurs et employeurs
%		\begin{itemize}[leftmargin = *]
%			\item	Autofinancement et non des impôts;
...
%%%%	--------------
%		\end{itemize}
%	\item[Période cotisable]
%		\begin{itemize}[leftmargin = *]
%			\item	Début
%			\item	Période servant au calcul de la rente de retraite se termine à la fin du premier des mois suivants:
%			\item	Continuer à travailler mais recevoir une rente de retraite implique une continuation de la cotisation au régime.
%		\end{itemize}
%	\item[Exemption générale]
%		\begin{itemize}[leftmargin = *]
%			\item	Si se salaire est inférieur à 3 500\$, aucune cotisation au RRQ;
%			\item	Gelé depuis 1998.
%		\end{itemize}
%	\item[Maximum des gains admissibles] (MGA)
%		\begin{itemize}[leftmargin = *]
%			\item	Si le salaire est supérieur à la limite, le salaire en sus n'est pas assujettis à des cotisation;
%			\item	Le MGA augmente selon la croissance du salaire moyen hebdomadaire au Canada;
%			\item	Détails sur le calcul utilisant l'année précédente.
%		\end{itemize}
%	\item[Taux de cotisation]
%		\begin{itemize}[leftmargin = *]
%			\item	Stable à 1.8\% pendant 20 ans (1966 à 1986);
%			\item	A été augmenté de graduellement et plus rapidement depuis 1998;
%			\item	Mécanisme d'auto-ajustement en place depuis 2018 pour rétablir l'équilibre du financement s'il y a lieu;
%			\item	Détails sur ce que représente le taux de cotisation;
%			\item	Le travailleur autonome paye la partie du travailleur \textit{et} employeur.
%		\end{itemize}
%	\item[Varia]
%		\begin{itemize}[leftmargin = *]
%			\item	Cotisation obligatoires;
%			\item	Dès l'âge de 18 ans;
%			\item	Cotisations font sont un crédit pour les impôts;
%			\item	On cotise uniquement sur des revenus de travail;
%			\item	Pouvons racheter des années de revenus de travail manquantes;
%			\item	Pas possible de récupérer des cotisations versées car elles sont acquises au régime.
%		\end{itemize}
%\end{description}

%\textbf{Prestations}---\textit{admissibilité}
%\begin{itemize}[leftmargin = *]
%	\item	La rente de retraite est payée à la personne qui en fait la demande âgée d'au moins 60 ans ayant cotisé au moins 1 an au régime;
%	\item	Peut recevoir sa rente tout en continuant de travailler;
%	\item	Rappel de la réduction actuarielle pour une retraite anticipée.
%\end{itemize}
