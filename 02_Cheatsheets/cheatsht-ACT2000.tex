...
Cependant, le biais n'indique pas la variabilité des prévisions de l'estimateur $\hat{\theta}_{n}$. Ceci est plutôt calculé avec la variance de l'estimateur $\text{Var}(\hat{\theta}_{n})$. 
\begin{distributions}[Notation]
\begin{description}
