...
\begin{distributions}[Notation]
\begin{description}
	\item[$\{X_{1}, \dots, X_{n}\}$]	Échantillon aléatoire sur lequel le test se fait;
...
%\begin{align*}
%	(\bar{x}	-	\bar{y})
%	&\pm	t_{\alpha/2, n - 2} s_{p}\sqrt{\frac{1}{n_{1}} + frac{1}{n_{2}}}
%\end{align*}

%%%	Différence de proportions
%\begin{align*}
%	\hat{p}_{1}	-	\hat{p}_{2}
%	&\pm	z_{\alpha/2} \sqrt{\frac{\hat{p}_{1}(1 - \hat{p}_{1}}{n_{1}} + frac{\hat{p}_{2}(1 - \hat{p}_{2}}{n_{2}}}
%\end{align*}
