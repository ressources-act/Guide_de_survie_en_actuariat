...
L'intuition est que mon ami se base uniquement sur la taille de l'écran comme information pour deviner le coût. Une régression \textbf{linéaire} simple applique un facteur \textbf{multiplicatif}. Il ne peut pas se dire que le plus grand l'écran de la TV, le plus le prix va augmenter---ceci serait une régression avec un paramètre \textbf{exponentiel}. 
