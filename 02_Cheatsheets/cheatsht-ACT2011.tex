...
\begin{conceptgen}{Tarification d'un \textbf{contrat à terme de gré à gré prépayé}}
Sans dividendes, on obtient un prix de $S_{0}$; soit, le prix de l'actif sous-jacent aujourd'hui. Dans le cadre d'une action cependant, il peut y avoir des dividendes. 
...
\begin{center}
	...
	Si la réponse à tous les questions est oui, alors il y a une opportunité d'arbitrage.
\end{center}
