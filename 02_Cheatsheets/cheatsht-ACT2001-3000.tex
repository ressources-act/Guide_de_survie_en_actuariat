...
\paragraph{Note}	Voir la section de visualisations pour une visualisation du produit de sommations infinies dans la preuve pour l'algorithme de De Pril \textit{\underline{\nameref{subsubsec:DePrilVis}}}.
